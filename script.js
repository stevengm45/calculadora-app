...
const writeResult = () => {
    ...
    // screenResult.textContent = lastValue().toString();
    if(screenResult.textContent.textContent.length>9){
        screenResult.style.fontSize = '1.3em';
        screenResult.style.marginTop = '.8em'
    }
